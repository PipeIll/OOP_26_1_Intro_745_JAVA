...
public class Workshop {
    ...
    public int[] combinarArreglos(int[] arreglo1, int[] arreglo2) {
        ...
        int[] combinado = new int[Longitud];
    ...
    public int[] rotarArreglo(int[] arreglo, int posiciones) {
        ...
        for (int i = 0; i < n; i++) {
           rotado[(i + desplazamiento) % n] = arreglo[i];
         }
        return rotado;
    }
...
Rock crushes Scissors
    ...
    public String zoodiac(int day, int month) {
        ...
        if ((month == 8 && day >= 24) || (month == 9 && day <= 22)) return "virgo";
        if ((month == 9 && day >= 23) || (month == 10 && day <= 23)) return "Libra";
        if ((month == 10 && day >= 24) || (month == 11 && day <= 22)) return "Escorpio";
        if ((month == 11 && day >= 23) || (month == 12 && day <= 21)) return "Sagitario";
